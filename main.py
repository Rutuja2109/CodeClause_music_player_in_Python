...
image_icon = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\logo.png")
root.iconphoto(False, image_icon)

Top = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\top.png")
...
ButtonPlay = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\play.png")
Button(root, image=ButtonPlay, bg="#0f1a2b", bd=0,
       command=PlayMusic).place(x=100, y=400)

ButtonStop = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\stop.png")
Button(root, image=ButtonStop, bg="#0f1a2b", bd=0,
       command=mixer.music.stop).place(x=30, y=500)

ButtonResume = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\resume.png")
Button(root, image=ButtonResume, bg="#0f1a2b", bd=0,
       command=mixer.music.unpause).place(x=115, y=500)

ButtonPause = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\pause.png")
Button(root, image=ButtonPause, bg="#0f1a2b", bd=0,
       command=mixer.music.pause).place(x=200, y=500)

# Label
Menu = PhotoImage(
    file=r"C:\Users\Admin\Downloads\CodeClause_Music_Player_in_Python\CodeClause_Music_Player_in_Python\images\menu.png")
